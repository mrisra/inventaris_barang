    ...
    public function user()
      {
          if ($this->uri->segment(4) === 'view') {
              ...
              $tampil = $this->crudModel->getDataWhere('user', 'user_id', $id)->row();
              ...
              $data = [
                  ...
                  'content' => 'admin/UpdateUser',
                  'navlink' => 'user',
              ];
          } else {
              $data = [
                  'user' => $this->crudModel->getData('user')->result(),
                  'content' => 'admin/user',
                  'navlink' => 'user',
              ];
          }
      ...
      {
          $add = [
              'user_id' => $this->crudModel->generateCode(10, 'user_id', 'user'),
          ...
          $this->crudModel->addData('user', $add);
      ...
      public function hapusUser()
      {
          ...
          $this->crudModel->deleteData('user', 'user_id', $user_id);
      ...
      public function ubahUser()
      {
          ...
          $this->crudModel->updateData('user', 'user_id', $user_id, $update);
