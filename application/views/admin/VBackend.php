    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url(); ?>">
                ...
                <div class="sidebar-brand-text mx-3">HALO <?= $this->session->userdata("role"); ?></div>
                   ...
                   <ul class="navbar-nav ml-auto">
                       ...
                       <li class="nav-item dropdown no-arrow">
                           <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                               <!-- <span class="mr-2 d-none d-lg-inline text-gray-600 small">Halo <b>Admin</b></span> -->
                               <span class="mr-2 d-none d-lg-inline text-gray-600 small">Selamat Datang <b><?= $this->session->userdata("nama"); ?></b></span>
                  ...
                  <div class="modal-dialog" role="document">
                      <div class="modal-content">
                          ...
                          <div class="modal-footer">
                              ...
                              <a class="btn btn-success" href="<?= site_url('admin/logout') ?>">Logout</a>
                          </div>
                      </div>
                  </div>
              </div>
