            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header card-header-warning">
                        <h4 class="card-title">Data Barang<button type="button" data-toggle="modal" data-target="#modalBarang" class="btn btn-primary float-right">Tambah Data</button></h4>
                        ...
                        <table class="table table-hover" id="datatables">
                            ...
                            <tbody>                                
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= site_url('admin/barang/'.$value->barang_id.'/view'); ?>" rel="tooltip" title="Edit Task" class="btn btn-primary">
                                            <i class="material-icons">Edit</i>
                                        </a>
                                        <a href="<?= site_url('admin/hapusBarang/'.$value->barang_id); ?>" rel="tooltip" title="Remove" class="btn btn-danger">
