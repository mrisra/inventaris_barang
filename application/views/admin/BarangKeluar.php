            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header card-header-warning">
                        <h4 class="card-title">Data Barang Keluar<button type="button" data-toggle="modal" data-target="#modalSupplier" class="btn btn-primary float-right">Tambah Data</button></h4>
                        ...
                        <table class="table table-hover" id="datatables">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <!-- <td><?= $value->total; ?></td> -->
                                    <td>
                                        <a href="<?= site_url('admin/barang_keluar/'.$value->id.'/view'); ?>" rel="tooltip" title="Edit Task" class="btn btn-primary">
                                            <i class="material-icons">Edit</i>
                                        </a>
                                        <a href="<?= site_url('admin/hapusBarangKeluar/'.$value->id); ?>" rel="tooltip" title="Remove" class="btn btn-danger">
