            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title">Data Perusahaan<button type="button" data-toggle="modal" data-target="#modalPerusahaan" class="btn btn-success float-right">Tambah Data</button></h4>
                        ...
                        <table class="table table-hover" id='datatables'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $value->no_telp; ?></td>
                                    <td>
                                        <a href="<?= site_url('petugas/perusahaan/'.$value->tujuan_id.'/view'); ?>" rel="tooltip" title="Edit Task" class="btn btn-primary">
