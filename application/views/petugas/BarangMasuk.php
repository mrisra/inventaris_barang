            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header card-header-warning">
                        <h4 class="card-title">Data Barang Masuk<button type="button" data-toggle="modal" data-target="#modalSupplier" class="btn btn-success float-right">Tambah Data</button></h4>
                        ...
                        <table class="table table-hover" id='datatables'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= site_url('petugas/barang_masuk/'.$value->id.'/view'); ?>" rel="tooltip" title="Edit Task" class="btn btn-primary">
